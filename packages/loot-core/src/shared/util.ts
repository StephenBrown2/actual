...
export function integerToFormattedWithDecimal(
  ...
  return integerToFormatted(integerAmount, undefined, decimalPlaces);
}
 ...
 * currencyToFormatted(amount) // Returns '$123.45'
 *
 * const euroAmount = { currency: getCurrency('EUR'), amount: 12345 };
 * currencyToFormatted(euroAmount) // Returns '123,45 €'
 *
 * const noSymbol = { currency: getCurrency(''), amount: 12345 };
 * currencyToFormatted(noSymbol) // Returns '123.45' (no currency symbol)
 */
