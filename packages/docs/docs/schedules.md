...
- **Import from JSON** — opens a review dialog: pick a `.json` schedules file, see a list of schedules in the file, select which rows to import, then import. Only the schedules you select are applied.
