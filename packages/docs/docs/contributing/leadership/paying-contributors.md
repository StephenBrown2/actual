...
Points are automatically calculated for all **public members of the Actual Budget organization** through our [GitHub workflow](https://github.com/actualbudget/actual/blob/master/.github/workflows/count-points.yml). Refer to the workflow documentation for the current point values assigned to different contributor actions.
