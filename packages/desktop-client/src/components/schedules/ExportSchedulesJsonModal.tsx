        ...
        <>
          ...
          <View style={{ ...styles.smallText, lineHeight: 1.5 }}>
            ...
            <Paragraph style={{ marginBottom: 12 }}>
              <Trans>
                Export all schedules in this budget to a JSON5 file.
              </Trans>
            </Paragraph>
            <Paragraph style={{ marginBottom: 12 }}>
              <Trans>
                Account, payee, category names and rule data are included
                so the file can be imported into another budget.
              </Trans>
            </Paragraph>
            <ButtonWithLoading
              variant="primary"
              isLoading={exporting}
              onPress={() => void onExport(close)}
            >
              <Trans>Export</Trans>
            </ButtonWithLoading>
          </View>
