        ...
        <>
          ...
          <View style={{ ...styles.smallText, lineHeight: 1.5 }}>
            ...
            <Button
              style={itemStyle}
              onPress={() =>
                dispatch(pushModal({ modal: { name: 'export-schedules-json' } }))
              }
            >
              ...
              <View style={{ color: theme.pageTextLight }}>
                <Trans>
                  Save a JSON5 file with schedules and linked rule data
                </Trans>
              </View>
            </Button>
            ...
            <Button
              style={itemStyle}
              onPress={() =>
                dispatch(pushModal({ modal: { name: 'import-schedules-json' } }))
              }
            >
              <span style={{ fontWeight: 700 }}>
